 ...
 * כלים שהוסרו (זה תפקידו - להחזיק רק את המצב הנוכחי), ולכן CaptureEffectTracker
 * שומר את זה בנפרד, לחלון זמן קצר (ר' CaptureEffectTracker.CAPTURE_EFFECT_DURATION_MS),
